...
We plan to create a premium version of Readup that will unlock access to top-quality content from publishers that currently paid subscriptions.

# **Who's behind Readup?**
Two friends, [Bill](https://www.billloundy.com) (CEO)
 and Jeff (CTO). We don't use social media, but we're fascinated by the internet and we love to read. We hope to grow the company, but first we need to grow the community. 

 # **How can I help?**
Spread the word! And send Bill a friendly email: bill@readup.com. We're love to hear from you. 